...
model = load_model(r'C:\Users\mails\OneDrive\Documents\GitHub\Agri-link\CropDoctor\plant_disease_model.h5')  # Added raw string for Windows path
with open(r'C:\Users\mails\OneDrive\Documents\GitHub\Agri-link\CropDoctor\classes.json', 'r') as f:
